...
export default function Home() {
	return (
		<>
			<div className='w-full px-10 pr-[15vw] md:pr-[3vw] mt-[5rem] md:mt-0'>
				<Image
				...
				<div className='grid grid-rows-1 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 lg:gap-8'>
					{/* <NewsCard
						title='From the magic of Monza to the laughter at press conferences, our writers pick their favourite moments from Sebastian Vettel'
						date='16 hours ago'
					/>
					<NewsCard
						title='dsad'
