...
export default function Navbar() {
  ...
  // return (
  //   <div className="font-sans font-bold justify-center">
  //     <div className="text-white">
  //       <div className="mx-5 my-[2%] leading-[3] w-[20%] pt-[20px] sidenav flex flex-col fixed z-1 top-0 left-0 bg-[#232323] duration-5000 ease-in-out overflow-x-hidden pt-[20px] flex flex-col items-center h-[94%]">
  //         <svg
  //           id="logo_v01-09"
  ...
  //         <Link
  //           to="/"
  //           className="text-[#fff] mt-[10%] active:border-2 active:px-[20%] active:rounded-[6px] active:border-[#00FF59] active:text-[#00FF59] active:mt-[10%]"
  //           onChange={() => setActiveHome(!activeHome)}
  //         >
  //           HOME
  //         </Link>
  //         <Link
  //           className="sidebar"
  //           to="/"
  //           onChange={() => setActiveNews(!activeNews)}
  //         >
  //           NEWS
  //         </Link>
  ...
  //           DRIVERS
  //         </Link>
  //         <Link className="sidebar" to="/constructors">
  //           CONSTRUCTORS
  //         </Link>
  //         <Link className="sidebar" to="/chat">
  //           CHAT ROOM
  //         </Link>
  //         <Link className="sidebar" to="/">
  //           DRIVERS
